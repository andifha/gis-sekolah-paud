...
<div class="col-md-5">
	<div class="panel panel-primary">
		...
		<div class="form-group">
			<label>NPSN</label>
			<input name="npsn" placeholder="NPSN" value="<?= $sekolah->npsn?>" class="form-control" />
		</div>
		...
		<div class="form-group">
			...
			<input name="latitude" placeholder="Latitude" value="<?= $sekolah->latitude?>" class="form-control" require />
		</div>

		<div class="form-group">
			<label>Longitude</label>
			<input name="longitude" placeholder="Longitude" value="<?= $sekolah->longitude?>" class="form-control" require />
		</div>
...
var map = L.map('map').setView([<?= $sekolah->latitude?>, <?= $sekolah->longitude?>], 14);
